...
"                                      stop: 0 #dadbde, stop: 1 #f6f7fa);}")
        ...
        self.studtable.setGeometry(QtCore.QRect(420, 120, 911, 351))
        self.studtable.setStyleSheet("COLOR: WHITE;\n"
"border: 1px solid white;")
        self.studtable.setObjectName("studtable")
        self.studtable.setColumnCount(9)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.studtable.setHorizontalHeaderItem(8, item)
...
"")
    ...
    def retranslateUi(self, Student_Data):
        ...
        item = self.studtable.horizontalHeaderItem(8)
        item.setText(_translate("Student_Data", "DOJ"))
